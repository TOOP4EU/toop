...
The main WAR file of the phoss SMP server to be used in a Java Application Server (like Tomcat) can be retrieved from http://repo2.maven.org/maven2/com/helger/peppol-smp-server-webapp-xml/5.1.2/peppol-smp-server-webapp-xml-5.1.2.war or see https://github.com/phax/phoss-smp/wiki/Download for further options (like a standalone Docker image). 
